...
This demonstration shows how the :ref:`Remote Procedure Call (RPC)<overview-proxy-rpc-work-label>` component is a shim over RPMSg providing the familiar Input/Output (IO) commands like open, read, write, close both for files and standard input/output.
